...
## **[Bachelor of Science in Geography (Normal)](https://swamp-maraca-1c5.notion.site/BS-Diploma-d66544652d5c4dd8b29109878d3785d3), Shanghai, China**

_2017.09-2021.06 (Shanghai Normal University)_
...
- [**Coursera**](https://www.coursera.org/user/3e6257745574d52616467134343dd6db)
  ...
  - `Computer Science`
    ...
    - [操作系统原理 - PKU](https://swamp-maraca-1c5.notion.site/Coursera-58fabde93bbb45438c85433bcf025bae)
...
## Internship of Geographical Data Analyst

**Urban Science Applications (Beijing) Co., Ltd. Shanghai Branch**

_Shanghai – (2021/09 - 2022/02)_

- Created thematic maps of automotive sales network with _QGIS_.
- Developed scripts to process spatial data with _Pyqgis_.
- Managed database of automotive sales network with Python and SQL.
- Crawled information from different websites related to automotive sales networks with _scrapy_.
...
_Shanghai – (2020/09 - 2021/01)_

- Created lesson plans for geography courses.
- Taught two classes of geography.
...
- Python Level II (Outstanding)

---

# 📜 Publications

- [**Ouwen Zhang**, Lijie Gao, Weiyue Li, Lishan Xiao. Predicting sludge generation patterns and carbon reduction potential under Shared Socioeconomic Pathways[J]. _Journal of Environmental Management_ (JCR Q1), 2022](https://www.sciencedirect.com/science/article/pii/S0301479722016619?dgcid=author#appsec1)

- [Lishan Xiao, Sha Huang, Zhilong Ye, **Ouwen Zhang**, Tao Lin. Identifying multiple stakeholders’ roles and network in urban waste separation management-a case study in Xiamen, China[J]. _Journal of Cleaner Production_ (JCR Q1), 2021](https://www.sciencedirect.com/science/article/abs/pii/S0959652620336143)
...
- [主频高的 CPU 性能一定比主频低的快吗?](https://zhuanlan.zhihu.com/p/522635811)
...
- [OmniFood Index](https://zowomnifood.netlify.app)

## Academic Projects

- Graduation Thesis (Research on)
